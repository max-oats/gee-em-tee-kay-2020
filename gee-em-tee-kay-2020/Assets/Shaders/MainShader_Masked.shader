...
////// Lighting:
                float attenuation = LIGHT_ATTENUATION(i);
                float3 finalColor = ((_Color_var.rgb*_MainTex_var.rgb)*_LightColor0.rgb*lerp(UNITY_LIGHTMODEL_AMBIENT.rgb,_Color_var.rgb,attenuation));
