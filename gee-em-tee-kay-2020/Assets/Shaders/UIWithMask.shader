    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float _TileY_var = UNITY_ACCESS_INSTANCED_PROP( Props, _TileY );
                float2 node_2430 = float2(i.uv0.r,(i.uv0.g+_TileY_var));
                float4 _Mask_var = tex2D(_Mask,TRANSFORM_TEX(node_2430, _Mask));
